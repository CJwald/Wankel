...
namespace Wankel {
    ...
    void InputSystem::PollControllers() {
        ...
        for (size_t i = 0; i < s_Gamepads.size() && i < (size_t)ControllerInput::MaxControllers; i++) {
            ...
            // FACE BUTTONS
            ControllerInput::SetButton((int)i, (int)GamepadButton::Cross, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_SOUTH));

            ControllerInput::SetButton((int)i, (int)GamepadButton::Circle, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_EAST));

            ControllerInput::SetButton((int)i, (int)GamepadButton::Square, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_WEST));

            ControllerInput::SetButton((int)i, (int)GamepadButton::Triangle, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_NORTH));

            // STICKS
            ControllerInput::SetButton((int)i, (int)GamepadButton::L3, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_LEFT_STICK));

            ControllerInput::SetButton((int)i, (int)GamepadButton::R3, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_RIGHT_STICK));

            // SHOULDERS
            ControllerInput::SetButton((int)i, (int)GamepadButton::L1, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER));

            ControllerInput::SetButton((int)i, (int)GamepadButton::R1, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER));

            // CENTER BUTTONS
            ControllerInput::SetButton((int)i, (int)GamepadButton::Back, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_BACK));

            ControllerInput::SetButton((int)i, (int)GamepadButton::Start, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_START));

            ControllerInput::SetButton((int)i, (int)GamepadButton::PS, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_GUIDE));

            // DPAD
            ControllerInput::SetButton((int)i, (int)GamepadButton::DPadUp, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_DPAD_UP));

            ControllerInput::SetButton((int)i, (int)GamepadButton::DPadDown, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_DPAD_DOWN));

            ControllerInput::SetButton((int)i, (int)GamepadButton::DPadLeft, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_DPAD_LEFT));

            ControllerInput::SetButton((int)i, (int)GamepadButton::DPadRight, SDL_GetGamepadButton(pad, SDL_GAMEPAD_BUTTON_DPAD_RIGHT));
        }
    }
