...
namespace Wankel {
	...
	// Events in Wankel are currently blocking. This means that when they
	// start they are handled imediately. In the future it would be better
	// to make an event bus and process them during an 'event' part of the
	// update stage
